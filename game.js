...
class Game {
    constructor() {
        this.ball = new Ball(canvas.width / 2, canvas.height / 2, 10, 6, 6);
        ...
        this.ball2 = new Ball(canvas.width / 2, canvas.height / 2, 5, 5, 5);
        this.ball3 = new Ball(canvas.width / 2, canvas.height / 2, 2, 8, 8);
        this.ball4 = new Ball(canvas.width / 2, canvas.height / 2, 15, 2, 2);
        this.ball5 = new Ball(canvas.width / 2, canvas.height / 2, 20, 4, 3);
    ...
    draw() {
        ...
        this.ball2.draw('pink');
        this.ball3.draw('purple');
        this.ball4.draw('lightblue');
        this.ball5.draw('lime');
        
        this.paddle1.draw('yellow', 100);
